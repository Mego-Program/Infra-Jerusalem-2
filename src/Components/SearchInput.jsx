...
const SearchInput = () => {
  return (
    ...
    <input
      className="w-full h-10 pl-10 pr-4 text-gray-700 placeholder-gray-400 border rounded-lg focus:outline-none "
      type="text"
      placeholder="Search..."
    />
    <div className="absolute top-0 left-0 flex items-center h-10 pl-3">
      <svg
